...
namespace MouseTracer
{
    class MouseHook
    {
        ...
        public static event EventHandler LeftClick = delegate { };
        public static event EventHandler MouseWheel = delegate { };
        public static event EventHandler ReightClick = delegate { };
